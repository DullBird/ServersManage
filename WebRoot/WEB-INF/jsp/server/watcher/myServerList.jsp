...
<html>
	<head>
		...
		<script type="text/javascript" src="${base}/js/server/watcher/myServerList.js"></script>
				...
				<div class="item active">
					<div class="panel panel-default">
			  			...
			  			<div class="panel-body">
			  				<!-- 搜索的表单 -->
			  				<form class="form-inline" name="pageForm" action="${base}/server/watcher/myServerList" method="post" >
